      ...
      <Modal open={showShare} onClickBackdrop={closeShare}>
        ...
        <div className="m-5 flex flex-col">
          <div className="flex items-center space-x-3 ml-5">
            <p className=" flex items-center flex-1  text-slate-500 border-slate-300 rounded-md border-dashed border-2 p-2 text-xs">
              Link :{" "}
              <span className="font-semibold  mx-2  text-xs  text-black">
                https://github.com/Krushna-shinde
              </span>
            </p>
            <CopyToClipboard
              text={"https://github.com/Krushna-shinde"}
              onCopy={() => {
                setCopyLink(!copyLink);
              }}
            >
          ...
          <h2 className=" ml-11 p-2 h-5 text-sm  font-semibold">
