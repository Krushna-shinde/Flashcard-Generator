...
// NavBar Route
jest.mock("./Componants/NavBar/NavBar", () => {
  return {
...
jest.mock("./Componants/CreateFlashCard/CreateFlashCard", () => {
  return {
    CreateFlashCard: () => (
      <div data-testid="create-flashcard">Create Flashcard</div>
    ),
  };
});
...
//MyFlashcard Route
jest.mock("./Componants/MyFlashCard/MyFlashCard", () => {
  return {
...
jest.mock("./Componants/Details/FlashCardDetails", () => {
  return {
    FlashCardDetails: () => (
      <div data-testid="flashcard-details">My Flashcard</div>
    ),
  };
});
